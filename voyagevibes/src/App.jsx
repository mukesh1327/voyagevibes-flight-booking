    ...
    return (
      <div className="app-container" style={{ justifyContent: 'center', alignItems: 'center' }}>
        <Plane
          ...
          color="var(--primary)"
          className="loader"
          style={{ animation: 'spin 2s linear infinite', border: 'none', width: 'auto', height: 'auto' }}
        />
      </div>
    );
  }
    ...
    <BrowserRouter>
      <div className="app-container">
        ...
        <Routes>
          <Route
            path="/"
            element={<Navigate to={user ? (user.baseRole === 'corporate' ? '/corporate/dashboard' : '/customer/dashboard') : '/login'} />}
          />
